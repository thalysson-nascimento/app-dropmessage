...
export const EN_TRANSLATIONS: I18nTranslationsBase = {
  ...
  text: {
    ...
    videoRewardTitle: 'Earn +4 likes',
    videoRewardDescription:
      'Watch a short video to boost your match chances in the dating app.',
    videoRewardLoading: 'Loading the ad... please wait a moment.',
    videoRewardWebHint:
      'Browser detected. The ad will be simulated for testing.',
    videoRewardErrorLoad: 'Unable to load the ad.',
    videoRewardChecking: 'Reward received! Validating...',
    videoRewardReleased: 'Reward released! You may continue.',
    videoRewardConfirmError: 'Unable to confirm the reward.',
    videoRewardIncomplete: 'Video not completed. You can try again.',
    ...
    post_visible_subtitle:
      'Your post is now visible to your matches and temporarily published.',
    ...
    commentPostTitle: 'Comment on post',
    commentPostSubtitle: 'What do you think of {{name}}\'s post?',
    commentSuccess: 'Comment sent successfully!',
    commentUnlockTitle: 'Comments locked',
    commentUnlockDescription: 'To be able to comment on this post, please watch a sponsored video.',
    checkingStatus: 'Checking post status...',
  },
};
